...
<body>
  ...
  <section class="vh-80" style="background-image: url('login/img/mobil.jpg'); background-size: cover; position: relative;">
        ...
        <div class="col-12 col-md-8 col-lg-6 col-xl-5">
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              ...
              <a href="signup.php" class="btn btn-lg btn-block btn-primary" style="background-color: #dd4b39;">
